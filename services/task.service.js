...
export function addTask(taskName_1) {
...
export function getTasks(_a) {
    return __awaiter(this, arguments, void 0, function* ({ status = null, archived = null, priority = null, updatedBy, }) {
        try {
            ...
            const tasks = yield Task.aggregate([
                { $match: query },
                {
                    $lookup: {
                        from: "users",
...
export function updateTask(id_1, _a) {
    return __awaiter(this, arguments, void 0, function* (id, { priority, status, archived, updatedBy }) {
        try {
            ...
            const updatedTask = yield Task.findByIdAndUpdate(id, updated, { new: true });
            if (!updatedTask) {
